    ...
    */
    ...
    echo '<input id="dfThumbnail" '.$imageChecked.' type="checkbox" name="wpcufpn_dfThumbnail" value="'.htmlspecialchars("Thumbnail").'">';
    ...
    */
    ...
    echo '<input id="dfTitle" '.$titleChecked.' type="checkbox" name="wpcufpn_dfTitle" value="'.htmlspecialchars("Title").'">';
    ...
    */
    ...
    echo '<input id="dfAuthor"'.$authorChecked.' type="checkbox" name="wpcufpn_dfAuthor" value="'.htmlspecialchars("Author").'">';
    ...
    */
    ...
    echo '<input id="dfDate"'.$dateChecked.' type="checkbox" name="wpcufpn_dfDate" value="'.htmlspecialchars("Date").'">';
    echo '<label for="dfDate">'. __( 'Date', 'wp-latest-posts' ).'</label>' .'<br/>';    

     /**
    * display category field
    */
    echo '<input type="hidden" name="wpcufpn_dfCategory" value="">';
    echo '<input id="dfCategory" '.$categoryChecked.' type="checkbox" name="wpcufpn_dfCategory" value="'.htmlspecialchars("Category").'">';
    ...
    */
    ...
    echo '<input id="dfText"'.$textChecked.' type="checkbox" name="wpcufpn_dfText" value="'.htmlspecialchars("Text").'">';
    ...
    */
    ...
    echo '<input id="dfReadMore"'.$readMoreChecked.' type="checkbox" name="wpcufpn_dfReadMore" value="'.htmlspecialchars("Read more").'">';
